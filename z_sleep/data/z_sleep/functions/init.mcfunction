...
tellraw @a [{"text":"Z_Sleep Loaded, click "},{"text":"[here]","color":"blue","clickEvent":{"action":"suggest_command","value":"/function z_sleep:settings/show"}},{"text":" to change settings."}]
